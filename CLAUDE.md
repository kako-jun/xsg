...
- `/api/patterns/{pattern_id}` が展開済みJSONを返すように変更
...
- `/api/patterns`エンドポイントでYAMLをスキャンしてメタデータ抽出
- カテゴリ別に自動分類（Color Bars, Geometric, Grayscale & Gradients, Professional, Solid Colors）
- 14個の主要パターンにメタデータ追加完了
